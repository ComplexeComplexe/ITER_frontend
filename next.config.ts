...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // SEO-06: Fix remaining 404s reported by DataforSEO crawl (mai 2026)
      // EN/ES cocon sub-pages generated by DafPage with wrong locale prefix
      {
        source: "/en/daf-externalise/tarifs",
        destination: "/en/fractional-cfo/tarifs",
        permanent: true,
      },
      {
        source: "/en/daf-externalise/secteurs",
        destination: "/en/fractional-cfo/secteurs",
        permanent: true,
      },
      {
        source: "/es/daf-externalise/tarifs",
        destination: "/es/externalizacion-daf/tarifas",
        permanent: true,
      },
      {
        source: "/es/daf-externalise/secteurs",
        destination: "/es/externalizacion-daf/sectores",
        permanent: true,
      },
      {
        // /es/recursos/blog — typo in Spanish path (recursos vs ressources)
        source: "/es/recursos/blog/:path*",
        destination: "/es/ressources/blog/:path*",
        permanent: true,
      },
