...
<p>Selon les informations disponibles, le périmètre SIRH de malibou couvre la paie et les déclarations, les absences et congés, le télétravail, les notes de frais, la gestion des temps, les entretiens et objectifs, l'onboarding et l'offboarding, ainsi que les exports comptables — le périmètre exact du forfait reste à confirmer selon le contrat retenu. Côté intégrations, l'éditeur mentionne des connexions avec des outils comme Pennylane, Qonto ou Swile ; la liste complète reste à confirmer.</p>
...
<p><strong>Un tarif tout inclus et lisible.</strong> Abonnement mensuel indexé sur le nombre de bulletins, sans option forcée annoncée. Selon l'éditeur, malibou permettrait environ 30 % d'économies à périmètre équivalent par rapport à des solutions comparables — chiffre communiqué par malibou, non vérifié de façon indépendante par Iter Advisors.</p>
...
<tr><td>Prix</td><td>Environ 20-25 €/salarié/mois, tout inclus</td><td>27 €/mois/salarié (Essential) à 49 €/mois/salarié (Performance)</td></tr>
...
<p><strong>Combien coûte malibou ?</strong><br>Selon l'éditeur, l'abonnement démarre autour de 20 à 25 €/salarié/mois, tout inclus, indexé sur le nombre de bulletins. Demandez un devis pour obtenir un tarif confirmé, adapté à votre effectif et à votre convention collective.</p>
