...
import { getOutsourceYourAccountingContent } from "@/lib/content/outsource-your-accounting";
import Link from "next/link";
import PageByline from "@/components/PageByline";
import { editorialWebPageSchema, FINANCE_AUTHOR } from "@/lib/schemas/editorial";

export async function generateMetadata(): Promise<Metadata> {
  const content = getOutsourceYourAccountingContent("en");
  return buildMetadata({
    locale: "en",
    path: "/services/outsource-your-accounting",
    localizedPaths: {
...
export default async function OutsourceYourAccountingPage() {
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify(
                editorialWebPageSchema({
                  path: "/en/services/outsource-your-accounting",
