...
const fallbackDescriptions: Record<ServicePageSlug, string> = {
  ...
  "gestion-financiere-externalisee":
    "Hire a fractional CFO from 2 days/month. Monthly reporting, budget management and financial strategy for startups and SMEs. Barcelona, Paris, Toulouse.",
  "accompagnement-levee-de-fond":
  ...
  "controle-de-gestion-externalise":
    "Part-time management control: KPI dashboards, variance analysis, cost optimisation and performance monitoring. Actionable insights from day one.",
};
