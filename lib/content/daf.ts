  ...
  fr: {
    ...
    tempsPartage: {
      ...
      content: [
        ...
        "Chez Iter Advisors nous proposons ces formats — c'est votre besoin qui dicte le mode, pas l'inverse. Pour l'intervention **récurrente sur la durée** (quelques jours par mois, sans durée minimale et avec un préavis de 30 jours), notre page dédiée détaille les missions et tarifs : [DAF à temps partagé : directeur financier 1 à 8 jours par mois](/daf-externalise/temps-partage). Le format transition, lui, répond à une urgence : remplacement, crise, restructuration.",
      ],
    },
    vsExpertComptable: {
