...
const servicesFr: ServicesContent = {
  ...
  services: [
    ...
    { title: "Formation & développement", href: "/services/formation-developpement", category: "rh" },
    { title: "Conformité & droit du travail", href: "/services/conformite-droit-travail", category: "rh" },
  ],
  whyOutsource: {
